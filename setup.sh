...
sleep 0.5
clear
wget https://raw.githubusercontent.com/ayan-testing/AutoScriptXray/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
echo "---------------------------t.me/ayan-testing-----------------------------" | tee -a log-install.txt
echo "==================================================================" | tee -a log-install.txt
echo -e ""
echo ""
echo "" | tee -a log-install.txt
